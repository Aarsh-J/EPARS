...
PERFORMANCE_RAW_MEDIANS: dict[str, float] = _perf_spec["raw_medians"]
...
BURNOUT_LOW_MAX: float = _burnout_meta["low_max"]
BURNOUT_MEDIUM_MAX: float = _burnout_meta["medium_max"]
BURNOUT_TOP_FEATURES: dict[str, float] = _burnout_meta["top_features"]
BURNOUT_LIVE_MEDIANS: dict[str, float] = _burnout_meta["live_medians"]
