...
# The current burnout model buckets into 3 classes (Low/Moderate/High), not the
# previous model's 4 (no more "Critical") — see modules/ml/predict.py.
THRESHOLD_CLASSES = ("High",)
